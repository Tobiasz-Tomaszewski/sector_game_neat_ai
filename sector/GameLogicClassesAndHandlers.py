...
class Player:
    def __init__(self, centre_, radius, player_radius, curve_nr=0, path_deviation=0,
...
class Obstacle:
    ...
    def __str__(self):
        return f'[inner_radius: {self.inner_radius}, outer_radius: {self.outer_radius}, start_angle: {self.start_angle}, angle: {self.angle}, speed: {self.speed}]'
